...
class App:
    ...
    def Comm(self, tosend):
        ...
        # mind the dirty hack here: yi4k replies with 16777220 after photo is captured (instead of 769)
        if msgid == 769: msgid = 16777220
        self.JsonData[msgid] = ""
        if self.DebugMode:
    ...
    def MenuControl(self, *args):
        ...
        # mind the dirty hack here: yi4k doesn't have preview_status in config (?)
        ...
        # mind the dirty hack here: yi4k doesn't support zoom (at least rval=-23 looks like a error)
